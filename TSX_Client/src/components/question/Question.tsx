          ...
          <div className="question-list-content">
            <div className="question-item-content">
              <div className="icon-question">
                <img
                  src="https://onthisinhvien.com/resources/images/otsv/icon1-why-choose.svg"
                  alt=""
                />
              </div>
            ...
            <div className="question-item-content">
              <div className="icon-question">
                <img
                  src="https://onthisinhvien.com/resources/images/otsv/icon3-why-choose.svg"
                  alt=""
                />
              </div>
              <div className="question-title">
            ...
            <div className="question-item-content">
              <div className="icon-question">
                <img
                  src="https://onthisinhvien.com/resources/images/otsv/icon2-why-choose.svg"
                  alt=""
                />
              </div>
              <div className="question-title">
