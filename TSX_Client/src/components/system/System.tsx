  ...
  return (
    <div className="container">
      <div className="system-content-container">
        ...
        <div
          className={`first-system system-description ${
            activeIndex === 0 ? "block" : "hidden"
          }`}
        >
          <div className="system-image">
            <img
              src="https://onthisinhvien.com/resources/images/tam-nhin.png"
              alt=""
            />
          </div>
        ...
        >
          <div className="system-image">
            <img
              src="https://onthisinhvien.com/resources/images/su-menh.png"
              alt=""
            />
          </div>
        ...
        >
          <div className="value-system">
            <div className="value-image">
              <img
                src="https://onthisinhvien.com/resources/images/otsv/tam-huyet.svg"
                alt=""
              />
            </div>
          ...
          <div className="value-system">
            <div className="value-image">
              <img
                src="https://onthisinhvien.com/resources/images/otsv/chat-luong.svg"
                alt=""
              />
            </div>
            <div className="value-content">
          ...
          <div className="value-system">
            <div className="value-image">
              <img
                src="https://onthisinhvien.com/resources/images/otsv/con-nguoi.svg"
                alt=""
              />
            </div>
            <div className="value-content">
